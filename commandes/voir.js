...
if(!msgRepondu){return repondre("*mec Veuillez mentionner un message envoyé en vue unique🍥🍃* .");}
...
{
   return repondre("mec Le message que vous avez mentionné n est pas un message envoyé en vue unique 🍃🍥.")
}
